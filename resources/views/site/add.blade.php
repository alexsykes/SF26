<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-slate-800 dark:text-slate-200 leading-tight">
            Add a new Site - drag the Marker to the launch point
        </h2>
    </x-slot>
        ...
        <div class="visible p-2 text-sm  bg-white shadow-xl flex mt-4 ml-4 mr-4 h-full flex-1 flex-col gap-1 rounded-xl border border-neutral-200 ">
            ...
            <div class="mt-2 grid grid-cols-1 gap-x-4 gap-y-2 sm:grid-cols-4">
                <div class="sm:col-span-4">
                    <div class=" mb-2">Where a location provides distinct sites for different
                        wind directions, please add full details in the About box or add multiple sites.
                    </div>
                    <label for="site_name" class="block  font-semibold ">Name (Required)</label>
                    <div class="mt-2 ">
                        <div>
                            <input type="text"
                ...
                <div class="sm:col-span-4">
                    <label for="near" class="block  font-semibold ">Location (Required)</label>
                    <div class="mt-2">
                        <input type="text"
                               class="w-full md:w-1/2"
                               name="near"
                ...
                <div class="sm:col-span-full">
                    <label for="w3w" class="block  font-semibold ">What3Words (Optional - but helpful)</label>
                    <div class="mt-2">
                        <div>
                            <input type="text"
                                   class="w-full md:w-1/2"
                                   ...
                                   id="w3w"
                                   placeholder="eg. fingers.ruin.flights">
                        </div>
                    </div>
                    @error('w3w')
                    <p class="text-xs text-red-500 font-semibold mt-1">{{ $message }}</p>
                ...
                <div class="col-span-full">
                    <label for="site_description" class="block  font-semibold ">About (Required)</label>
                    <div class="mt-2">
                                <textarea name="site_description"
                                          ...
                                          placeholder="Please give as much information as you can about the site. "></textarea>
                    </div>
                </div>
                ...
                <div class="col-span-full">
                    <label for="site_access" class="block  font-semibold ">Access (Required)</label>
                    <div class="mt-2">
                  <textarea
                          name="site_access"
                          id="site_access"
                          ...
                          class="block w-full rounded-md bg-white px-3 py-1.5 text-base  outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:"
                          placeholder="Please give information about how to access the site and any special rules or restrictions."></textarea>
                    </div>
