<x-guest-layout>
    ...
    <form id="registerForm" method="POST" action="{{ route('register') }}">
        ...
        <!-- Name -->
        <div class="font-semibold pt-2">Please remember to check the box below to confirm your acceptance of our Terms
        ...
        {{--        <div class="pt-2 pb-2 font-semibold">Difficulties registering? Please let us know - <a--}}
        {{--                    href="mailto:info@slopefinder.uk?Subject=Registration">click here</a></div>--}}
                <div>
        <x-input-label for="name" :value="__('Name')"/>
        <x-text-input id="name" class="border block mt-1 w-full" type="text" name="name" :value="old('name')"
        ...
        <div class="flex mt-4">
            <x-text-input id="agree" class="border-1 border-blue-600  mt-1"
                          type="checkbox"
                          name="agree" required/>
            <x-input-label class="ml-2 font-semibold" for="agree"
                           :value="__('I have read and agree to the Terms and Conditions detailed on this website - see link below.')"/>
        </div>
        <div>
